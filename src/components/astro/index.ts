// Exportar todos los componentes Astro
export { default as AstroFooter } from './Footer.astro';
export { default as AstroHeader } from './Header.astro';
...
export { default as AstroCallToActionSection } from './CallToActionSection.astro';
export { default as AstroLayout } from './Layout.astro';